...
namespace NGettextUtils
{
    ...
    static class msgidCollector
    {
        ...
        public static string WritePOT( Dictionary<string, List<string>> msgids, string catalog, string output, bool append = true )
        {
            StringBuilder lines = new StringBuilder();
            foreach ( KeyValuePair< string, List < string >> msgid in msgids )
            {
                foreach(string line in msgid.Value )
                {
